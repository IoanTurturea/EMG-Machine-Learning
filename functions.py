...
def prepare_train_val_test():
    ...
    # reshape x_train
    length = np.size(x_train)
    x_train = np.reshape(x_train, (int(length / 400), 1, 400))
    print(x_train.shape)
...
def prepare_xy_train_val_test():
    ...
    x_train = np.reshape(x_train, (int(np.size(x_train) / 400), 1, 400))
    print(x_train.shape)
    x_val = np.reshape(x_val, (int(np.size(x_val) / 400), 1, 400))
    print(x_val.shape)
    x_test = np.reshape(x_test, (int(np.size(x_test) / 400), 1, 400))
    print(x_test.shape)
...
def prepare_xy_train_val_test_asnumpyarrays():
    ...
    print(x_train.shape)
    x_val = np.reshape(x_val, (int(np.size(x_val) / 400), 400))
    print(x_val.shape)
    x_test = np.reshape(x_test, (int(np.size(x_test) / 400), 400))
    print(x_test.shape)
